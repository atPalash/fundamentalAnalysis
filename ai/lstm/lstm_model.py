...
class LstmModel(ai_model_interface.AiModelInterface):
    def __init__(self, name, config, past_data_count=50, debug=False, debug_count=2):
    ...
    def build_model(self):
        ...
        self.lstm.init_model(selected_stocks_df=self.data, train_test_ratio=0.8, epochs=20)
    ...
    def __initialise_data(self):
        ...
        self.lstm = LstmPredictor(model_save_folder_path=self.lstm_config['models_folder'], selected_feature='Close',
